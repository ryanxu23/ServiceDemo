...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *demoViewController = [[ESTBeaconTableVC alloc] initWithScanType:ESTScanTypeBeacon
        ...
        //[demoViewController.navigationController pushViewController:notificationDemoVC animated:YES];
    }];
    
    
    //self.mainNavigation = [[UINavigationController alloc] initWithRootViewController:demoList];
    
    self.mainNavigation = [[UINavigationController alloc] initWithRootViewController:demoViewController];
    ...
    {
        [self.mainNavigation pushViewController:demoViewController animated:YES];
    }
    */
